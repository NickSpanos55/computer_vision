...
1. **Initial Image**:
   ...
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
     <img src="./assets/Screenshot_1.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
   </div>

2. **Noise Addition**:
   - Images for $$\(PSNR = 20dB\)$$ and $$\(PSNR = 10dB\)$$ demonstrate the impact of varying levels of noise.
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_2.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_3.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
   </div>
...
1. **Gaussian and Laplacian of Gaussian (LoG) Kernels**:
   ...
   - Kernels exhibit:
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">    
      <img src="./assets/Screenshot_4.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_5.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
   </div>
...
2. **Smoothing with Gaussian Kernel**:
   ...
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">     
      <img src="./assets/Screenshot_6.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_7.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
   </div>
...
3. **Edge Detection Methods**:
   ...
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_8.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_9.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
   </div>
   ...
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_10.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_11.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
   </div>

   - **Result Comparison**:
     - Non-linear methods display cleaner edges, especially at \(PSNR = 10dB\), as noise has less impact on edge clarity.
     <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_12.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_13.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_14.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_15.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
     </div>

     <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_16.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_17.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_18.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_19.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
     </div>
---
...
1. **Binary Edge Sign Maps** ($$\(X\)$$):
   ...
   - Results show trade-offs between edge retention and noise suppression:
     ...
     <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_20.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_21.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
     </div>
     
     - Lower $$\(\theta_{edge}\)$$ retains noise but maintains more detailed edges.
     <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_21.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
      <img src="./assets/Screenshot_22.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
     </div>
2. **PSNR Observations**:
...
1. **Building Edge Detection**:
   - For an image like "duomo_edges.jpg," containing fine, closely packed edges, parameter tuning is crucial:
     ...
     <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_23.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 250px;"/>
...
2. **Comparison**:
   ...
   <div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 0 auto;">
      <img src="./assets/Screenshot_25.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 400px;"/>
      <img src="./assets/Screenshot_26.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 400px;"/>
      <img src="./assets/Screenshot_27.jpg" alt="YCbCr Color Space Diagram" style="width: 250px; height: 400px;"/>
     </div>
